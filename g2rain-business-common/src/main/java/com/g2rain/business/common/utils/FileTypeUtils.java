...
public class FileTypeUtils {
	...
	private static void initAllFileType() {
		 ...
		 * FILE_TYPE_MAP.put("46726f6d3a203d3f6762", "eml"); //Email [Outlook Express 6]
		 * (eml) FILE_TYPE_MAP.put("d0cf11e0a1b11ae10000", "doc"); //MS Excel
		 * 注意：word、msi 和 excel的文件头一样 FILE_TYPE_MAP.put("d0cf11e0a1b11ae10000", "vsd");
		 * //Visio 绘图 FILE_TYPE_MAP.put("5374616E64617264204A", "mdb"); //MS Access
		 * (mdb) FILE_TYPE_MAP.put("252150532D41646F6265", "ps");
